...
export const PORTFOLIO_ITEMS : PortfolioItem[] = 
  [
    ...
    new PortfolioItem('Whitepaper - A Guide to Connectivity for OpenFin Architects and Developers',
    ...
    new PortfolioItem('Open Source Project - SolCharts',
    ...
    new PortfolioItem('Udemy Course - Battleship over Solace PubSub+',
